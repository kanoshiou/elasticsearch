...
public abstract class AbstractStringPattern implements StringPattern {
    ...
    public final Automaton createAutomaton(boolean ignoreCase) {
        return createAutomaton(ignoreCase, null);
    }

    public final Automaton createAutomaton(boolean ignoreCase, CircuitBreaker breaker) {
        try {
            return doCreateAutomaton(ignoreCase, breaker);
        } catch (TooComplexToDeterminizeException e) {
            throw new IllegalArgumentException("Pattern was too complex to determinize", e);
        }
    }

    protected abstract Automaton doCreateAutomaton(boolean ignoreCase, CircuitBreaker breaker);
