...
public class RLikePattern extends AbstractStringPattern implements Writeable {
    ...
    protected Automaton doCreateAutomaton(boolean ignoreCase, CircuitBreaker breaker) {
        ...
        Automaton nfa = new RegExp(regexpPattern, RegExp.ALL | RegExp.DEPRECATED_COMPLEMENT, matchFlags).toAutomaton();
        return breaker != null
            ? CircuitBreakingOperations.determinize(nfa, Operations.DEFAULT_DETERMINIZE_WORK_LIMIT, breaker, "esql-like-rlike")
